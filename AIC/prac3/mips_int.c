...
void detectar_riesgos_datos(void) {
    ...
    switch (solucion_riesgos_datos) {
        case parada:
            ...
            if ((ID_EX.IR.Rdestino==IF_ID.IR.Rfuente1) && escribe_Rdst(ID_EX.IR) && lee_Rfte1(IF_ID.IR)) {
                    IFstall=SI;
                    IDstall=SI;
               }
            ...
            if ((EX_MEM.IR.Rdestino==IF_ID.IR.Rfuente1) && escribe_Rdst(EX_MEM.IR) && lee_Rfte1(IF_ID.IR)){
                    IDstall=SI;
                    IFstall=SI;
               }
