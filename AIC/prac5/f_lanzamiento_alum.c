...
#define I_PRED_DATA IF_ISS_2.pred_data
    ...
    switch (I_OP) {
        ...
        case OP_FP_S_D:
            /*** Busca un hueco en el tampón/buffer de escritura */
            ...
            /*** Reserva el tampón/buffer de escritura */
            
              /* INSERTAR CÓDIGO */
              if(s>FIN_BUFFER_ALMACEN) return; //No hay espacio
              SB[s].ocupado = SI;
              SB[s].OP = I_OP;
              SB[s].rob = b;
            ...
            /*** Reserva la estación de reserva */
              ...
              /* INSERTAR CÓDIGO */
              if(s>FIN_RS_SUMREST) return; //No hay espacio
              RS[s].ocupado = SI;
              RS[s].OP = I_OP;
              RS[s].rob = b;
        ...
        case OP_FP_DIV_D:
            ...
            /*** Reserva el operador virtual */
              ...
              /* INSERTAR CÓDIGO */
              if(s>FIN_RS_MULTDIV) return; //No hay espacio
              RS[s].ocupado = SI;
              RS[s].OP = I_OP;
              RS[s].rob = b;
